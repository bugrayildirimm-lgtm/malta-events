...
<body>
  <div class="nav">
    <a href="/" style="display:flex;align-items:center;gap:10px"><img src="/logo.png" alt="Malta Event Guide" style="height:34px;border-radius:5px"></a>
...
<body>
  <nav style="background:#0f172a;padding:12px 24px;display:flex;align-items:center;justify-content:space-between;position:relative;z-index:20">
    <a href="/" style="display:flex;align-items:center;gap:10px;text-decoration:none">
      <img src="/logo.png" alt="Malta Event Guide" style="height:36px;border-radius:8px;background:#0f172a">
      <span style="color:white;font-weight:700;font-size:1.05rem;letter-spacing:-0.3px">Malta Event Guide</span>
    </a>
    <a href="https://www.instagram.com/maltaeventguide/" target="_blank" rel="noopener" style="color:#94a3b8;font-size:0.85rem;text-decoration:none;display:flex;align-items:center;gap:6px;transition:0.2s;padding:6px 14px;border:1px solid #334155;border-radius:20px" onmouseover="this.style.borderColor='#FF385C';this.style.color='#FF385C'" onmouseout="this.style.borderColor='#334155';this.style.color='#94a3b8'">
...
<body>
  <nav class="nav">
    <a href="/" style="display:flex;align-items:center;gap:8px;text-decoration:none"><img src="/logo.png" alt="Malta Event Guide" style="height:32px;border-radius:6px"><span style="color:white;font-weight:700;font-size:1rem">Malta Event Guide</span></a>
